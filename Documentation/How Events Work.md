...
As the time of this writing, Chilkat has 103 classes. ~~33~~ 39 of these classes contain events. This event handler class is the base handler for 27 of those ~~33~~ 39 classes. The other six classes subclass from this base event handler and have even more events.
